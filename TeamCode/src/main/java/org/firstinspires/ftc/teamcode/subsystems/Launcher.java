...
public class Launcher {
    ...
    private final double[][] launchMap = {
            ...
            {0.0,   440.0*(3.0/2.2)*.95, 0.68},//first point needs min values
            {15.0,  440.0*(3.0/2.2)*.95, 0.68},
            {25.0,  460.0*(3.0/2.2)*.95, 0.68},
            {35.0,  500.0*(3.0/2.2)*.95, 0.64},
            {60.0,  540.0*(3.0/2.2)*.95, 0.61},
            {87.0,  630.0*(3.0/2.2)*.95, 0.59},
            {105.0, 700.0*(3.0/2.2)*.95, 0.57},
            {120.0, 730.0*(3.0/2.2)*.95, 0.565},
            {130.0, 750.0*(3.0/2.2)*.95, 0.565},
            {150.0, 800.0*(3.0/2.2)*.95, 0.56},
            {200.0, 800.0*(3.0/2.2)*.95, 0.56}//last point needs max values
    };
