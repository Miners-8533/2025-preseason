...
public class AutonRedFarMany extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Pose2d pickLoadingZoneEnd   = mirrorPose(new Pose2d(65.0,-60.0, Math.toRadians(-90 )), isFlipped);
        ...
        TrajectoryActionBuilder tab2 = drive.actionBuilder(farScorePose)
                ...
                .splineToLinearHeading(pickLoadingZoneEnd, mirrorTangent(Math.toRadians(270), isFlipped),null, new ProfileAccelConstraint(-50,50));
